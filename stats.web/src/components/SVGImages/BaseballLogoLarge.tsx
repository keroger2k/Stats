        ...
        <svg width="32" height="32" viewBox="0 0 24 24" data-testid="icon-baseball" xmlns="http://www.w3.org/2000/svg">
            <g id="Baseball" fill="none" fillRule="evenodd">
                ...
                <g fillRule="nonzero">
                    ...
                    <path d="M19.778 19.778c4.296-4.296 4.296-11.26 0-15.556-4.296-4.296-11.26-4.296-15.556 0-4.296 4.296-4.296 11.26 0 15.556 4.296 4.296 11.26 4.296 15.556 0zM5.636 18.364a9 9 0 1 1 .21.203l-.21-.203z" fill="#0A0B0D">
                    </path>
                </g>
            </g>
        </svg>
